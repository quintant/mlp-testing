...
python3 run.py --run_id "hands_only" --batch_size 32 --num_workers 8 --lr 1e-5 --resolution 768 --center_crop --random_flip --dataparallel --no_split --num_generations 100 --num_images 64 --images_per_generation 16 --compile
