...
accelerate launch --multi_gpu --mixed_precision="fp16" python3 custom_train.py --run_id "hands_only" --batch_size 16 --num_workers 8 --lr 1e-5 --resolution 768 --center_crop --random_flip --dataparallel --no_split --num_generations 100 --num_images 64 --images_per_generation 32
